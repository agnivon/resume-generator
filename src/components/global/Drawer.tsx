      ...
      <AnimatePresence>
        {show && (
          <MotionDiv
            tabIndex={-1}
            aria-hidden="true"
            className="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto hide-scrollbar md:inset-0 h-screen max-h-full bg-black bg-opacity-40"
            onClick={onClose}
          >
            <MotionDiv
